...
CREATE UNIQUE INDEX zone_short_name_idx
  ON zones (short_name);
...
CREATE UNIQUE INDEX camera_url_idx
  ON cameras (url);
...
CREATE UNIQUE INDEX users_unique_email_idx
  ON users (email);
CREATE UNIQUE INDEX users_unique_telegram_name_idx
...
CREATE UNIQUE INDEX events_unique_trigger_datetime_idx
  ON events (trigger_id, date_time)